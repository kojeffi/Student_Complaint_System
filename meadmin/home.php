	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="inner-content">
				...
				<footer>
					<p>&copy 2022 Augment . All Rights Reserved | Design by <a href="omondi jeff" target="_blank">Omondi.</a> and Develop By Omondi Jeff</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
		...
		<div class="sidebar-menu">
			<header class="logo">
				<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="#">
                    <span id="logo"> <h1>MeJeff</h1></span>
			...
			<!--/down-->
			<div class="down">
				<a href="#"><img src="images/jeff.jpg" style="width: 100px"></a>
