...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="#"><i class="fa fa-leanpub" aria-hidden="true"></i>
                    Student<b class="text-danger">Complaint<br>Management System</a></h1>
			...
			<ul class="agile_forms">
				<li><a class="active" href="index[1].php">
                        <i class="fa fa-sign-in" aria-hidden="true">
                        </i> Sign In now</a> </li>

                <li><a class="active" href="registration.php">
                        <i class="fa fa-sign-in" aria-hidden="true">
                        </i> Sign Up now</a> </li>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						<li class="active"><a href="index5.php" class="effect-3">HOME</a></li>
				...
				<form action="index_handler.php" method="post" class="mod2">
					<div class="col-md-6 col-xs-6 w3l-left-mk">
						<ul>
							...
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="st_fullname" type="text" required=""></li>
							<li class="text">Date of Birth :  </li>
							<li class="agileits-main"><i class="fa fa-calendar" aria-hidden="true">

                                </i><input class="date" id="datepicker" name="st_dob" type="text" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="" /></li>
							<li class="text">Father Name  :  </li>
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="st_father" type="text" required=""></li>
							<li class="text">Gender  :  </li>
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="st_gender" type="text" required=""></li>
						</ul>
					</div>
					<div class="col-md-6 col-xs-6 w3l-right-mk">
						<ul>
							<li class="text">mobile no  :  </li>
							<li class="agileits-main"><i class="fa fa-phone" aria-hidden="true"></i><input name="st_mobile" type="text" required=""></li>
							<li class="text">Address  :  </li>
							<li class="agileits-main"><i class="fa fa-home" aria-hidden="true"></i><input name="st_address" type="text" required=""></li>
							<li class="text">District  :  </li>
							<li class="agileits-main"><i class="fa fa-map-marker" aria-hidden="true"></i><input name="st_district" type="text" required=""></li>
							<li class="text">State  :  </li>
							<li class="agileits-main"><i class="fa fa-map-marker" aria-hidden="true"></i><input name="st_address" type="text" required=""></li>
						</ul>
					</div>
					<div class="clearfix"></div>
	...
	<div class="container">
		...
		<div class="col-md-7 wthree-services-bottom-grids">
			<div class="wthree-services-left">
				<img src="images/ab1.jpg" alt=""style="">
			</div>
			<div class="wthree-services-right">
				<img src="assets/images/bg2.jpg" alt="" style="height: 500px">
			</div>
			<div class="clearfix"> </div>
		</div>
		...
		<div class="agile_banner_bottom_grids">
			...
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:info@example.com"></a>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© - 2022 Scholarly.
            All rights reserved | Design by <a href="http://w3layouts.com">Omondi Jeff.</a> Developed
            By Omondi Jeff</p>
	</div>
</div>
