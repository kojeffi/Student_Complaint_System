...
<head>
	<title>Augment an Admin Panel Category | Home :: Omondi Jeff</title>
	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="inner-content">
						...
						<div class="tab-inner">
							<div id="tabs" class="tabs">
								...
								<div class="graph">
									<nav>
										<ul>
											<li><a href="#section-1" class="icon-shop"><i class="lnr lnr-briefcase">

                                                    </i> <span>Information</span></a></li>
											<li><a href="#section-2" class="icon-cup"><i class="lnr lnr-lighter">

                                                    </i> <span>Change Password</span></a></li>
											<li><a href="#section-3" class="icon-food">
                                                    <i class="fa fa-user-circle-o" aria-hidden="true">

                                                    </i> <span>Teachers</span></a></li>
				...
				<footer>
					<p>&copy 2020 Augment . All Rights Reserved | Design by <a href="Omondi Jeff" target="_blank">
                            Omondi Jeff.</a> and Develop By Omondi Jeff</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
